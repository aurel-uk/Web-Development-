            ...
            <div class="row g-4">
                ...
                <div class="col-lg-2">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2">
                            <a href="<?= SITE_URL ?>/views/Products.php" class="text-muted text-decoration-none">Produktet</a>
                        </li>
                        <li class="mb-2">
                            <a href="<?= SITE_URL ?>/views/Contact.php" class="text-muted text-decoration-none">Kontakt</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="col-lg-2">
                    ...
                    <ul class="list-unstyled">
                        <?php if (isLoggedIn()): ?>
                            <li class="mb-2">
                                <a href="<?= SITE_URL ?>/views/user/dashboard.php" class="text-muted text-decoration-none">Dashboard</a>
                            </li>
                            <li class="mb-2">
                                <a href="<?= SITE_URL ?>/views/user/Profile.php" class="text-muted text-decoration-none">Profili</a>
                            </li>
                        <?php else: ?>
                            <li class="mb-2">
                                <a href="<?= SITE_URL ?>/views/Auth/Login.php" class="text-muted text-decoration-none">Hyr</a>
                            </li>
                            <li class="mb-2">
                                <a href="<?= SITE_URL ?>/views/Auth/Register.php" class="text-muted text-decoration-none">Regjistrohu</a>
                            </li>
                        <?php endif; ?>
                    </ul>
                </div>
                ...
                <div class="col-lg-4">
                    ...
                    <ul class="list-unstyled text-muted">
                        ...
                        <li class="mb-2">
                            <i class="bi bi-envelope me-2"></i>info@webplatform.com
                        </li>
                        <li class="mb-2">
