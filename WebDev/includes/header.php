...
// Inicializo aplikacionin (nëse nuk është ngarkuar ende)
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?= SITE_URL ?>/pages/products.php">
                ...
                <ul class="navbar-nav">
                    <?php if (isLoggedIn()): ?>
                        <!-- Cart Icon -->
                        <li class="nav-item">
                            <a class="nav-link" href="<?= SITE_URL ?>/pages/cart.php">
                    ...
                    <?php else: ?>
                        ...
                        <li class="nav-item">
                            <a class="btn btn-light btn-sm ms-2" href="<?= SITE_URL ?>/auth/register.php">
